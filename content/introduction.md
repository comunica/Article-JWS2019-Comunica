...
Some time ago we released our initial resource paper about [Comunica](cite:cites taelman_iswc_2018)
...
to handle their querying of Linked Data.

{.todo}
Update the structure section below based on final structure.
